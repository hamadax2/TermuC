...
public class MainActivity extends AppCompatActivity {
    ...
    private void runTermux(){ try{Intent i=new Intent("com.termux.app.RUN_COMMAND");i.setPackage("com.termux");i.putExtra("com.termux.RUN_COMMAND_PATH","/data/data/com.termux/files/usr/bin/bash");i.putExtra("com.termux.RUN_COMMAND_ARGUMENTS",new String[]{"-lc","echo 'TermuC: open the project file in shared storage to compile/run it.'"});i.putExtra("com.termux.RUN_COMMAND_BACKGROUND",false);sendBroadcast(i);toast("Sent command to Termux");}catch(Exception e){toast("Termux is not available");}}
