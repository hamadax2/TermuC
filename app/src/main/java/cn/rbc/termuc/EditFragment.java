...
TextEditor.OnEditedListener {
    ...
    // Lightweight debounced auto-save: one write after the user pauses typing.
    private final Handler autoSaveHandler = new Handler(Looper.getMainLooper());
    private final Runnable autoSaveTask = new Runnable() {
        @Override public void run() {
            try {
                if (getView() != null && getView().isEdited()) save();
    ...
    private void scheduleAutoSave() {
        ...
        autoSaveHandler.postDelayed(autoSaveTask, 1200);
    }
