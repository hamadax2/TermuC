...
public class Utils {
	...
	public static void run(Context cont, String cmd, String[] args, String pwd, boolean background) {
        // Use the original Termux RunCommandService integration.
        // This is intentionally kept compatible with the original TermuC workflow.
        try {
            cont.getPackageManager().getPackageInfo(TERMUX, PackageManager.GET_SERVICES);
        } catch (PackageManager.NameNotFoundException e) {
            HelperUtils.show(Toast.makeText(cont, "Termux is not installed", Toast.LENGTH_SHORT));
            return;
        }
